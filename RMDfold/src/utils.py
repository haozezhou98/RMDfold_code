...
sincfold_path=r'D:\src'
CT2DOT_CALL = f"export DATAPATH={sincfold_path}/tools/RNAstructure/data_tables; {sincfold_path}/tools/RNAstructure/ct2dot"
DRAW_CALL = f"export DATAPATH={sincfold_path}/tools/RNAstructure/data_tables;  {sincfold_path}/tools/RNAstructure/draw -c -u --svg -n 1"
VARNA_PATH = f"{sincfold_path}/tools/varna/VARNAv3-93.jar"
if system() == "Windows":
    VARNA_PATH = ""
    CT2DOT_CALL = ""
    DRAW_CALL = ""
