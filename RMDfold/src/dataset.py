...
class SeqDataset(Dataset):
    def __init__(
        self, dataset_path, min_len=0, max_len=600, verbose=False, cache_path=None, for_prediction=False,
        interaction_prior="probmat", use_cannonical_mask=True, training=False,
 **kargs):
        """
